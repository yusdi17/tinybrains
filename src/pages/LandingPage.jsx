...
export default function LandingPage() {
  ...
  // Opsional: Refresh AOS saat komponen dimuat ulang (berguna untuk React Router)
useEffect(() => {
    AOS.init({
      offset: 200,
      duration: 400,
      easing: "ease-in-sine",
      delay: 90,
      once: false, // Animasi berulang setiap scroll (opsional)
    });
    
    // Refresh AOS jika ada perubahan rute/konten dinamis
    AOS.refresh();
  }, []);
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-300 font-sans selection:bg-cyan-500/30 overflow-x-hidden">
      ...
      <div className="fixed inset-0 z-0 pointer-events-none">
        <div className="absolute top-[-10%] left-[-10%] w-[500px] h-[500px] bg-purple-600/20 rounded-full blur-[120px] opacity-40 animate-pulse"></div>
        <div className="absolute bottom-[-10%] right-[-10%] w-[500px] h-[500px] bg-cyan-600/20 rounded-full blur-[120px] opacity-40 animate-pulse delay-700"></div>
      ...
      >
        ...
        {isMobileMenuOpen && (
          <div className="md:hidden bg-slate-900 border-b border-white/10 animate-fade-in-down">
      ...
      <section className="relative pt-32 pb-20 lg:pt-48 lg:pb-32 px-4 overflow-hidden">
        <div className="max-w-4xl mx-auto text-center relative z-10">
          ...
          <div 
            className="inline-flex items-center px-3 py-1 rounded-full border border-cyan-500/30 bg-cyan-950/30 text-cyan-400 text-xs font-medium mb-8 backdrop-blur-sm"
            data-aos="fade-down"
            data-aos-delay="100"
          >
      ...
      <section id="about" className="py-20 bg-slate-900/50 border-y border-white/5 relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {/* Feature 1 */}
            <div 
              className="p-8 rounded-2xl bg-slate-950 border border-slate-800 hover:border-cyan-500/50 transition-colors group"
              data-aos="fade-up"
              data-aos-delay="0"
            >
            ...
            {/* Feature 2 */}
            <div 
              className="p-8 rounded-2xl bg-slate-950 border border-slate-800 hover:border-purple-500/50 transition-colors group"
              data-aos="fade-up"
              data-aos-delay="200"
            >
            ...
            {/* Feature 3 */}
            <div 
              className="p-8 rounded-2xl bg-slate-950 border border-slate-800 hover:border-blue-500/50 transition-colors group"
              data-aos="fade-up"
              data-aos-delay="400"
            >
      ...
      <section className="py-24 px-4 relative overflow-hidden">
        ...
        <div 
          className="max-w-4xl mx-auto relative z-10 text-center bg-slate-900/50 border border-white/10 p-12 rounded-3xl backdrop-blur-sm"
          data-aos="zoom-in-up"
          data-aos-offset="300"
        >
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
             <Link to="/register" className="px-8 py-4 rounded-xl bg-white text-slate-950 font-bold hover:bg-slate-200 transition-colors">
              Gabung Sekarang
            </Link>
