...
export default function Login() {
  return (
    <div className="min-h-screen bg-slate-950 flex items-center justify-center p-4 relative overflow-hidden">
      ...
      {/* Background Effects */}
      <div className="absolute top-[-10%] left-[-10%] w-[500px] h-[500px] bg-purple-600/20 rounded-full blur-[120px] opacity-30 pointer-events-none"></div>
      <div className="absolute bottom-[-10%] right-[-10%] w-[500px] h-[500px] bg-cyan-600/20 rounded-full blur-[120px] opacity-30 pointer-events-none"></div>
      ...
      <div className="relative w-full max-w-md bg-slate-900/60 backdrop-blur-xl border border-white/10 rounded-2xl p-8 shadow-2xl shadow-cyan-900/20">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-slate-400 text-sm mt-1">Akses neural network pribadimu.</p>
        </div>
        ...
        <form className="space-y-5">
          ...
          <div>
            <div className="flex justify-between items-center mb-1">
              ...
              <Link to="/forgot-password" className="text-xs text-cyan-400 hover:text-cyan-300 transition-colors">Lupa Password?</Link>
            </div>
            <input 
              type="password" 
              placeholder="••••••••" 
        ...
        <div className="mt-8 text-center">
          <p className="text-slate-400 text-sm">
            Belum punya akun?{' '}
            <Link to="/register" className="text-cyan-400 hover:text-white font-medium transition-colors">
              Daftar sekarang
            </Link>
          </p>
        </div>
